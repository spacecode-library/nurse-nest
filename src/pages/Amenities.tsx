...
import { Dumbbell, Coffee, Clock, Car, Plane, MapPin, Waves, Users, Music, BookOpen, Heart, Smile, Utensils, Wine } from 'lucide-react';
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<Heart key={0} />, <Dumbbell key={1} />, <Waves key={2} />, <Smile key={3} />],
