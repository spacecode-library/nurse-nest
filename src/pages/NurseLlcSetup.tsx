        ...
        <AnimatedSection animation="fade-up" delay={800}>
          <section className="py-16 bg-gradient-to-br from-[#9bcbff] to-[#3b82f6] text-white text-center">
            <div className="container max-w-3xl mx-auto px-4">
              ...
              <a href="/sign-in" className="inline-block px-8 py-4 bg-white text-[#3b82f6] rounded-lg font-semibold hover:bg-gray-100 transition-colors shadow hover-lux-scale shine-on-hover">Learn More About Opportunities</a>
            </div>
          </section>
        </AnimatedSection>
      </main>
