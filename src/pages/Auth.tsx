  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <main className="relative min-h-screen pt-16">
        ...
        <div 
          className="hidden md:block fixed inset-0 w-full h-full bg-cover bg-no-repeat z-0"
          style={{
        ...
        <div 
          className="md:hidden fixed inset-0 w-full h-full bg-cover bg-no-repeat z-0"
          style={{
            backgroundImage: 'url(/lovable-uploads/e50ae826-ca23-44da-a4c5-e11cf4307c20.png)',
        ...
        <div className="relative z-10 min-h-screen flex">
          {/* Desktop form positioning - Keep unchanged */}
          <div className="hidden md:flex w-full items-center justify-end pr-4 sm:pr-8 lg:pr-16">
            ...
            <div className="w-full max-w-sm bg-white/95 backdrop-blur-sm rounded-2xl p-6 my-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <Button
                  className="w-full h-12 bg-blue-500 hover:bg-blue-600 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 text-sm"
                  disabled={loading}
                  type="submit"
                >
                  {loading ? (
          ...
          {/* Mobile form positioning - Centered with proper viewport fitting */}
          <div className="md:hidden w-full min-h-screen flex items-center justify-center p-4">
            <div className="w-full max-w-sm bg-white/95 backdrop-blur-sm rounded-2xl p-6 mx-auto">
              
              {/* Header image - Bigger for mobile */}
              <div className="mb-4 text-center">
                <img 
                  src="/lovable-uploads/b03954bb-8493-4e23-a285-627ff87efdb8.png" 
                  alt="Healthcare Reimagined" 
                  className="max-w-full h-auto max-h-24 object-contain mx-auto drop-shadow-lg"
                />
              </div>
