    ...
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <main className="relative pt-16">
        ...
        <div className="flex flex-col md:flex-row w-full h-auto md:h-screen">
          ...
          {/* Left Side - Background Image (60% on desktop) */}
          <div 
            className="w-full md:w-3/5 h-64 md:h-full bg-cover bg-center bg-no-repeat relative"
            style={{
          ...
          <div className="w-full md:w-2/5 flex items-center justify-center p-4 md:p-8 bg-gradient-to-br from-slate-50 to-white">
            <div className="w-full max-w-md">
              ...
              <div className="bg-white/30 backdrop-blur-md rounded-xl border border-white/20 p-6 shadow-lg">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            className="h-12 bg-white/60 backdrop-blur-sm border border-white/30 focus:border-[#9bcbff] rounded-lg shadow-sm placeholder-gray-700"
                            required
                          ...
                          <div className="relative">
                            <div className={`flex items-center space-x-4 p-4 border-2 rounded-lg cursor-pointer transition-all hover:border-[#3b82f6] hover:bg-blue-50/50 hover:shadow-md backdrop-blur-sm ${
                              userType === 'client' 
                                ...
                                : 'border-white/30 bg-white/40 shadow-sm'
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="h-12 pl-12 bg-white/60 backdrop-blur-sm border border-white/30 focus:border-[#9bcbff] rounded-lg shadow-sm placeholder-gray-700"
                        required
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="h-12 pl-12 pr-12 bg-white/60 backdrop-blur-sm border border-white/30 focus:border-[#9bcbff] rounded-lg shadow-sm placeholder-gray-700"
                        required
