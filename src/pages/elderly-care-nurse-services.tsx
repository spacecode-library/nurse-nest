          ...
          <div className="container max-w-4xl mx-auto px-4 flex flex-col gap-8 text-center">
            <h1 className={`font-extrabold text-4xl md:text-5xl lg:text-6xl tracking-tight text-[#1e293b] leading-tight mb-3 md:mb-6 font-sans transition-all duration-700 ease-out ${
              ...
              <span className={`block text-2xl md:text-3xl font-medium mt-2 text-blue-700 transition-all duration-700 ease-out delay-100 ${
                ...
                Supporting Seniors with Dignity and Compassion
              </span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <article className="flex-1 max-w-4xl">
              ...
              {/* Core Principles Section with animated cards */}
              <AnimatedSection animation="fade-up" delay={600}>
                <section id="understanding-elderly-care" className="mb-12">
                  ...
                  <div className="lux-floating-insight bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 mb-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-8">
                    <div className="bg-white rounded-lg p-6 shadow-sm border hover-lux-scale">
                      <div className="flex items-center gap-3 mb-4">
                        <LuxIcon><Heart className="w-6 h-6 text-red-500" /></LuxIcon>
                    ...
                    <div className="bg-white rounded-lg p-6 shadow-sm border hover-lux-scale">
                      <div className="flex items-center gap-3 mb-4">
                        <LuxIcon><Shield className="w-6 h-6 text-blue-500" /></LuxIcon>
                    ...
                    <div className="bg-white rounded-lg p-6 shadow-sm border hover-lux-scale">
                      <div className="flex items-center gap-3 mb-4">
                        <LuxIcon><Users className="w-6 h-6 text-green-500" /></LuxIcon>
                    ...
                    <div className="bg-white rounded-lg p-6 shadow-sm border hover-lux-scale">
                      <div className="flex items-center gap-3 mb-4">
                        <LuxIcon><CheckCircle className="w-6 h-6 text-purple-500" /></LuxIcon>
              ...
              <AnimatedSection animation="fade-up" delay={1000}>
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 text-white text-center my-12">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link 
                      to="/contact" 
                      className="bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-flex items-center justify-center gap-2 hover-lux-scale"
                    >
                      Get Started
                    ...
                    <Link 
                      to="/resources" 
                      className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors inline-flex items-center justify-center gap-2 hover-lux-scale"
                    >
                      Download Care Guide
            ...
            <AnimatedSection animation="slide-in-right" delay={700}>
              <aside className="lg:w-80 space-y-8">
                ...
                {/* Related Resources */}
                <div className="lux-floating-insight bg-gradient-to-br from-purple-50 to-blue-50 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Related Resources</h3>
                  <div className="space-y-3">
                    <Link to="/newborn-nurse-support-guide" className="block p-3 bg-white rounded-lg hover:shadow-md transition-shadow hover-lux-scale">
                    ...
                    <Link to="/wound-care-nursing-guide" className="block p-3 bg-white rounded-lg hover:shadow-md transition-shadow hover-lux-scale">
                    ...
                    <Link to="/post-surgical-care" className="block p-3 bg-white rounded-lg hover:shadow-md transition-shadow hover-lux-scale">
