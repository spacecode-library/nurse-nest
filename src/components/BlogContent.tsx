...
const blogPosts = {
  'understanding-private-duty-nursing': {
    ...
    content: `
      ...
      <h2>What is Private Duty Nursing?</h2>
      ...
      <h2>Who Benefits from Private Duty Nursing?</h2>
      ...
      <h2>Why Choose Private Duty Nursing?</h2>
      ...
      <h2>How Does Private Duty Nursing Work?</h2>
      ...
      <h2>The Future of In-Home Nursing Care</h2>
  ...
  'choose-right-private-duty-nurse': {
    ...
    content: `
      ...
      <h2>Why Choosing the Right Nurse Matters</h2>
      ...
      <h2>Key Tips for Hiring a Private Duty Nurse</h2>
      ...
      <h3>2. Verify Qualifications and Experience</h3>
      ...
      <h3>4. Evaluate Personality and Compatibility</h3>
      ...
      <h3>5. Check Reliability and Professionalism</h3>
      ...
      <h3>6. Understand Costs and Billing</h3>
      ...
      <h2>How Nurse Nest Simplifies the Process</h2>
  ...
  'nurse-nest-difference': {
    ...
    content: `
      ...
      <h3>4. Client-Centric Support</h3>
      ...
      <h2>Why Private Duty Nursing with Nurse Nest?</h2>
