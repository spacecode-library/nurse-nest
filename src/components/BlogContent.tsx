...
const blogPosts = {
  'understanding-private-duty-nursing': {
    ...
    content: `
      ...
      <h2 class="text-2xl font-bold mt-8 mb-4 text-nurse-dark">What is Private Duty Nursing?</h2>
      ...
      <h2 class="text-2xl font-bold mt-8 mb-4 text-nurse-dark">Who Benefits from Private Duty Nursing?</h2>
      ...
      <h2 class="text-2xl font-bold mt-8 mb-4 text-nurse-dark">Why Choose Private Duty Nursing?</h2>
      ...
      <h2 class="text-2xl font-bold mt-8 mb-4 text-nurse-dark">How Does Private Duty Nursing Work?</h2>
      ...
      <h2 class="text-2xl font-bold mt-8 mb-4 text-nurse-dark">The Future of In-Home Nursing Care</h2>
      ...
      <h2 class="text-2xl font-bold mt-8 mb-4 text-nurse-dark">Conclusion</h2>
  ...
  'choose-right-private-duty-nurse': {
    ...
    date: 'May 3, 2025',
    author: 'Nurse Nest Team',
    image: 'https://images.unsplash.com/photo-1530026186672-2cd00ffc50fe?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80',
    content: `
      ...
      <h2 class="text-2xl font-bold mt-8 mb-4 text-nurse-dark">Why Choosing the Right Nurse Matters</h2>
      ...
      <h2 class="text-2xl font-bold mt-8 mb-4 text-nurse-dark">Key Tips for Hiring a Private Duty Nurse</h2>
      
      <h3 class="text-xl font-bold mt-6 mb-3 text-nurse-dark">1. Define Your Needs</h3>
      ...
      <h3 class="text-xl font-bold mt-6 mb-3 text-nurse-dark">2. Verify Qualifications and Experience</h3>
      ...
      <h3 class="text-xl font-bold mt-6 mb-3 text-nurse-dark">3. Ask the Right Questions</h3>
      ...
      <h3 class="text-xl font-bold mt-6 mb-3 text-nurse-dark">4. Evaluate Personality and Compatibility</h3>
      ...
      <h3 class="text-xl font-bold mt-6 mb-3 text-nurse-dark">5. Check Reliability and Professionalism</h3>
      ...
      <h3 class="text-xl font-bold mt-6 mb-3 text-nurse-dark">6. Understand Costs and Billing</h3>
      ...
      <h3 class="text-xl font-bold mt-6 mb-3 text-nurse-dark">7. Seek Recommendations</h3>
      ...
      <h2 class="text-2xl font-bold mt-8 mb-4 text-nurse-dark">How Nurse Nest Simplifies the Process</h2>
  ...
  'nurse-nest-difference': {
    ...
    content: `
      ...
      <h2 class="text-2xl font-bold mt-8 mb-4 text-nurse-dark">What Makes Nurse Nest Unique?</h2>
      <p>Nurse Nest combines transparency and expertise to deliver exceptional nurse matching services:</p>
      
      <h3 class="text-xl font-bold mt-6 mb-3 text-nurse-dark">1. Pre-Vetted Nurses</h3>
      ...
      <h3 class="text-xl font-bold mt-6 mb-3 text-nurse-dark">2. Transparent Pricing</h3>
      ...
      <h3 class="text-xl font-bold mt-6 mb-3 text-nurse-dark">3. Specialized Matching</h3>
      ...
      <h3 class="text-xl font-bold mt-6 mb-3 text-nurse-dark">4. Client-Centric Support</h3>
      ...
      <h2 class="text-2xl font-bold mt-8 mb-4 text-nurse-dark">Why Private Duty Nursing with Nurse Nest?</h2>
      ...
      <h2 class="text-2xl font-bold mt-8 mb-4 text-nurse-dark">Who We Serve</h2>
