...
export default function MobileMenu({ 
  ...
  return (
    ...
    >
      ...
      {/* Menu content - Positioned off-screen when closed */}
      <div 
        className={cn(
          'absolute right-0 top-0 h-full w-full max-w-sm bg-white transform transition-transform duration-300 ease-in-out shadow-xl',
          isOpen ? 'translate-x-0' : 'translate-x-full'
        )}
      >
