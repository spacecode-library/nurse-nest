...
export default function EinApplicationsSidebar() {
  return (
    <aside className="w-full lg:max-w-xs flex-shrink-0 pt-2">
      ...
      <div className="mb-10 p-6 bg-blue-50 border-l-4 border-[#9bcbff] rounded-xl shadow-md">
        ...
        <ul className="space-y-3 text-base text-blue-700">
          ...
          <li><a href="/nurse-llc-setup-guide" className="hover:underline font-medium">LLC Setup Guide</a></li>
          <li><a href="/business-bank-account-for-nurses" className="hover:underline font-medium">Business Banking Guide</a></li>
          <li><a href="/blog/ein-vs-ssn-what-nurses-need-to-know" className="hover:underline font-medium">EIN vs SSN Comparison</a></li>
          <li><a href="/blog/nurse-llc-formation-guide" className="hover:underline font-medium">LLC Formation Guide</a></li>
        </ul>
      </div>
      {/* Quick Links */}
      <div className="p-6 bg-gray-100 rounded-xl shadow-md">
        ...
        <div className="flex flex-col gap-4">
          <a href="https://legalzoomcominc.pxf.io/aOYdEN" target="_blank" rel="noopener" className="w-full text-center px-4 py-2 bg-[#9bcbff] text-white rounded-md font-medium transition hover:bg-[#3b82f6] hover:shadow-lg">LegalZoom Business Services</a>
