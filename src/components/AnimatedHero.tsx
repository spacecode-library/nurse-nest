  ...
  return (
    <div className="w-full flex items-center justify-center min-h-screen">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-start justify-center text-left max-w-4xl mx-auto">
          <div className="space-y-8">
            <h1 className="text-4xl md:text-5xl lg:text-7xl tracking-tighter font-regular text-white leading-none">
              <span className="block text-white mb-2">Need a</span>
              <span className="relative flex w-full justify-start overflow-hidden text-left h-16 lg:h-20 items-center mb-2">
                &nbsp;
                {titles.map((title, index) => (
                  <motion.span 
                    key={index} 
