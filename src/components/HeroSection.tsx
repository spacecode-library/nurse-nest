        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative animate-fade-in">
            <div className="relative w-full aspect-[4/3] rounded-xl overflow-hidden shadow-2xl">
              <img 
                src="https://images.unsplash.com/photo-1584516150794-3e3d668c2854?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80"
              ...
              <div className="absolute -bottom-6 -right-6 w-36 h-36 rounded-full border-4 border-white bg-white shadow-xl overflow-hidden">
                <img 
                  src="https://images.unsplash.com/photo-1631019553258-63fad912a3a1?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80"
