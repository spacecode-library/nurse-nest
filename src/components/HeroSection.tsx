  ...
  return <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute top-1/2 left-8 md:left-16 transform -translate-y-1/2 z-20">
        <div className="text-left py-0 my-[36px] rounded-none px-0 mx-0">
          <h1 className="text-5xl font-old-standard font-bold mb-2 text-sky-200 md:text-7xl my-0 mx-0 px-0 py-0 text-center">
            Need a nurse?
          </h1>
          <p className="text-2xl md:text-2xl text-white/90 font-old-standard font-bold py-0">
            We make it{' '}
          ...
          <p className="text-sm mt-4 tracking-wider font-old-standard text-left text-zinc-50 font-bold md:text-lg my-[127px] py-[120px]">
