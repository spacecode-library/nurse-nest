...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden" id="hero-section">
      ...
      {/* Mobile Layout */}
      <div className="md:hidden w-full relative h-screen flex items-end">
        <div 
      ...
      {/* Trust Indicators - Auto-display without scroll trigger */}
      <div className="absolute z-10 hidden md:block bottom-8 left-0 right-0">
        <div className="container mx-auto px-4">
          <div 
            className="flex flex-wrap items-center justify-center gap-8 text-white/80 opacity-100" 
            style={{
              animation: 'fade-in 0.8s ease-out 1s both' // Auto-play animation with 1s delay
            }}
          >
