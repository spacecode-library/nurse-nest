  ...
  return <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute top-1/2 left-8 md:left-16 transform -translate-y-1/2 z-20">
        <div className="text-left py-0 my-[36px] rounded-none px-0 mx-0">
          ...
          color: '#9bcbff',
          fontWeight: '900'
        }} className="mb-4 tracking-wider font-roboto-regular text-left text-zinc-50 md:text-lg mb-4 md:mb-12 pt-8 md:pt-24 py-[180px] text-sm">
            Need a nurse?
          </h1>
          <p className="text-2xl md:text-2xl text-white font-roboto-extrabold italic py-0" style={{
          fontWeight: '800'
        }}>
            We make it{' '}
          ...
          <p className="text-sm mt-4 tracking-wider font-roboto-regular text-left text-zinc-50 md:text-lg mt-4 md:mt-12 pt-8 md:pt-24" style={{
          fontWeight: '400'
        }}>
