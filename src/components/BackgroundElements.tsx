...
export default function BackgroundElements({ type = 'nursing', opacity = 0.2 }: BackgroundElementsProps) {
  return (
    <div className="absolute inset-0 overflow-hidden z-0" style={{ opacity }}>
      {/* Random shapes and nursing elements */}
      <div className="absolute top-10 left-[10%] w-64 h-64 opacity-40">
      ...
      {/* Stethoscope shape */}
      <div className="absolute top-[30%] right-[15%] w-32 h-32 opacity-30">
      ...
      {/* Medical Cross */}
      <div className="absolute bottom-[25%] left-[20%] w-36 h-36 opacity-35">
        <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      {/* Heartbeat Line */}
      <div className="absolute bottom-[10%] right-[10%] w-60 h-20 opacity-30">
        <svg viewBox="0 0 200 50" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          <path fill="none" stroke="#1E88E5" strokeWidth="3" d="M0,25 L40,25 L50,10 L60,40 L70,15 L80,25 L200,25" />
        </svg>
      </div>

      {/* Medicine Pill */}
      <div className="absolute top-[60%] left-[5%] w-32 h-16 opacity-30 rotate-45">
      ...
      {/* Nurse Cap */}
      <div className="absolute top-[15%] left-[60%] w-36 h-24 opacity-30">
      ...
      {/* Syringe */}
      <div className="absolute bottom-[40%] right-[20%] w-36 h-10 opacity-30 -rotate-45">
        <svg viewBox="0 0 120 30" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          <rect x="10" y="10" width="100" height="10" fill="#1E88E5" />
          <rect x="5" y="5" width="10" height="20" rx="2" fill="#1E88E5" />
          <rect x="110" y="13" width="10" height="4" fill="#1E88E5" />
          <path d="M15,15 L15,5 L20,5 L20,15 Z" fill="#1E88E5" />
          <path d="M25,15 L25,8 L30,8 L30,15 Z" fill="#1E88E5" />
          <path d="M35,15 L35,11 L40,11 L40,15 Z" fill="#1E88E5" />
          <circle cx="110" cy="15" r="5" fill="none" stroke="#1E88E5" strokeWidth="1" />
        </svg>
      </div>
      
      {/* Thermometer */}
      <div className="absolute top-[45%] left-[25%] w-10 h-36 opacity-30">
        <svg viewBox="0 0 30 120" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          <rect x="12" y="20" width="6" height="70" fill="none" stroke="#1E88E5" strokeWidth="2" />
          <circle cx="15" cy="95" r="12" fill="none" stroke="#1E88E5" strokeWidth="2" />
          <circle cx="15" cy="95" r="6" fill="#1E88E5" />
          <rect x="14" y="40" width="2" height="10" fill="#1E88E5" />
          <rect x="14" y="60" width="2" height="10" fill="#1E88E5" />
        </svg>
      </div>
      
      {/* Another blob for variety */}
      <div className="absolute top-[80%] right-[30%] w-40 h-40 opacity-30">
        <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
