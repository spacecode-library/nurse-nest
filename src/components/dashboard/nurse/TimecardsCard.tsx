// components/dashboard/nurse/TimecardsCard.tsx
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  <p className="text-gray-900">
                    {new Date(selectedTimecard.timestamp_submitted).toLocaleString()}
                  </p>
                </div>
                {selectedTimecard.timestamp_approved && (
                  <div>
                    ...
                    <p className="text-gray-900">
                      {new Date(selectedTimecard.timestamp_approved).toLocaleString()}
                    </p>
                  </div>
                )}
              </div>
