  ...
  return (
    <div className="min-h-screen  flex items-center justify-center overflow-hidden p-4l">
      <div className=" w-full relative max-w-5xl overflow-hidden flex flex-col md:flex-row shadow-xl">
        ...
        <div className="w-[15rem] h-[15rem] bg-[#9bcbff] absolute z-1 rounded-full bottom-0"></div>
          ...
          >
            <div>
              ...
              <input
                ...
                className={`text-sm w-full py-2 px-3 border rounded-lg focus:outline-none focus:ring-1 bg-white text-black focus:ring-[#9bcbff] ${
            ...
            <button
              type="submit"
              className="w-full bg-[#9bcbff] hover:bg-[#8bb9ee] text-white font-medium py-2 px-4 rounded-lg transition-colors"
            >
