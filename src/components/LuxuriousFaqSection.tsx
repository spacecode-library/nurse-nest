...
export default function LuxuriousFaqSection({ onClose }: LuxuriousFaqSectionProps) {
          ...
          <div className="max-w-4xl mx-auto flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold" style={{color: '#1e293b'}}>
                Frequently Asked <span style={{color: '#9bcbff'}}>Questions</span>
              </h1>
            </div>
            {onClose && (
              <button
          ...
          <div className="max-w-md mx-auto mb-8">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-300 focus:border-blue-300 transition-all"
                value={searchTerm}
                    ...
                    <div key={tab.id} className="p-6">
                      ...
                      <Accordion type="single" collapsible className="space-y-4">
                        {tab.faqs.filter(faq => 
                          ...
                          <AccordionItem key={index} value={`${tab.id}-${index}`} className="border border-gray-200 rounded-lg">
