  ...
  return (
    <section className="py-12 px-4 bg-brand-navy">
      <div className="max-w-4xl mx-auto text-center">
        <StarBorder 
          color={isOpen ? "#ef4444" : "#2563eb"} 
          speed="3s"
          className="inline-block"
        >
          <button
            onClick={onToggleFaq}
            className={`px-10 py-5 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl border-0 ${
              isOpen
